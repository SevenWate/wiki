...
实际应用中，[C++11 标准提供的random_device保证加密的安全性和随机性](https://docs.microsoft.com/en-us/cpp/standard-library/random-device-class?redirectedfrom=MSDN&view=vs-2019#remarks)
...
### 5.2 避免相对路径导致的安全问题（DLL、EXE劫持等问题）
