...
var InternalModuleWeb = class extends InternalModule {
  ...
  create_static_templates() {
    return __async(this, null, function* () {
      ...
      this.static_functions.set("daily_picture", this.generate_daily_picture());
      this.static_functions.set("daily_yiyan", this.generate_daily_yiyan());
      this.static_functions.set("daily_weather", this.generate_daily_weather());
      this.static_functions.set("daily_poetry", this.generate_daily_poetry());
    });
  }
  create_dynamic_templates() {
    return __async(this, null, function* () {
...
> \u2014 *${author}*`;
  ...
  generate_daily_picture() {
    return (size, query) => __async(this, null, function* () {
      ...
      return `![daily_random_picture](${url})`;
    });
  }
  generate_daily_yiyan() {
    return (query) => __async(this, null, function* () {
      const response = yield this.getRequest(`https://v1.hitokoto.cn/${query != null ? query : ""}`);
      const json = yield response.json();
      const author = json.from;
      const quote = json.hitokoto;
      const new_content = `> ${quote}
> \u2014 *${author}*`;
      return new_content;
    });
  ...
  generate_daily_weather() {
    return (city, language, tformat) => __async(this, null, function* () {
      const response = yield this.getRequest(`https://wttr.in/${city != null ? city : ""}${tformat != null ? tformat : "?format=%l+%t+%c"}`, {
        headers: {
          "Accept-Language": language != null ? language : "zh"
        }
      });
      return response.text();
    });
  }
  generate_daily_poetry() {
    return () => __async(this, null, function* () {
      const response = yield this.getRequest("https://v2.jinrishici.com/one.json");
      const json = yield response.json();
      const title = json.data.origin.title;
      const author = json.data.origin.author;
      const dynasty = json.data.origin.dynasty;
      const content = json.data.content;
      const new_content = `> ${content}
> \u2014 *${title}\xB7${author}\uFF08${dynasty}\uFF09*`;
      return new_content;
    });
  }
};
...
// node_modules/.pnpm/github.com+SilentVoid13+eta@73c499b027f0ccd2441b63_fofg7upxhiphestysdqrke3jh4/node_modules/eta/dist/eta.es.js
